...
public class BibliotekaDaoDerby implements BibliotekaDao {
	...
	public void updateKsiazka(Ksiazka k) {
		String SQL = "update ksiazki set tytul = ?, opis = ?, autor = ?, ilosc = ?, kategoria = ? where id = ?";
